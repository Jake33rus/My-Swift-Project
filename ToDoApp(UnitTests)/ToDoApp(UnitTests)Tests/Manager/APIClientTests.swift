...
class APIClientTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        super.setUp()
        mockURLSession = MockURLSession(data: "nil".data(using: .utf8), urlResponse: nil, responseError: nil)
        sut = APIClient()
    ...
    func testLoginUsesExpectedQueryParameters(){
        ...
        XCTAssertTrue(queryItems.contains(urlQueryName))
        XCTAssertTrue(queryItems.contains(urlQueryPassword))
    }
